...
import { LayoutDashboard, CalendarDays, CheckSquare, LogOut, Menu, X } from 'lucide-react'
...
const navLinks = [
  { href: '/chairperson/dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-5 w-5" />, exact: true },
  { href: '/chairperson/meetings', label: 'Meetings', icon: <CalendarDays className="h-5 w-5" /> },
  { href: '/chairperson/decisions', label: 'Decisions', icon: <CheckSquare className="h-5 w-5" /> },
]

export function ChairpersonLayout({ children }: ChairpersonLayoutProps) {
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-white/10">
          <p className="text-xs font-semibold text-white/40 uppercase tracking-wider">Chairperson</p>
        </div>
        ...
        <div className="border-t border-white/10 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/50 truncate">Chairperson</p>
            </div>
          </div>
        </div>
      </aside>
