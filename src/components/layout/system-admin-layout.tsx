...
const navLinks = [
  { href: '/system-admin/dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-5 w-5" />, exact: true },
  { href: '/system-admin/users', label: 'Users', icon: <Users className="h-5 w-5" /> },
  { href: '/system-admin/roles', label: 'Roles', icon: <Shield className="h-5 w-5" /> },
  { href: '/system-admin/tenants', label: 'Tenants', icon: <Building2 className="h-5 w-5" /> },
  { href: '/system-admin/configuration', label: 'Configuration', icon: <Sliders className="h-5 w-5" /> },
  { href: '/system-admin/audit-logs', label: 'Audit Logs', icon: <FileSearch className="h-5 w-5" /> },
]
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-white/10">
          <p className="text-xs font-semibold text-white/40 uppercase tracking-wider">System Admin</p>
        </div>
        ...
        <div className="border-t border-white/10 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/50 truncate">System Administrator</p>
            </div>
          </div>
        </div>
      </aside>
