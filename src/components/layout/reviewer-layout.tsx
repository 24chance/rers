...
import { LayoutDashboard, ClipboardList, User, LogOut, Menu, X } from 'lucide-react'
...
const navLinks = [
  { href: '/reviewer/dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-5 w-5" />, exact: true },
  { href: '/reviewer/assignments', label: 'My Assignments', icon: <ClipboardList className="h-5 w-5" /> },
  { href: '/reviewer/profile', label: 'Profile', icon: <User className="h-5 w-5" /> },
]
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-white/10">
          <p className="text-xs font-semibold text-white/40 uppercase tracking-wider">Reviewer Portal</p>
        </div>
