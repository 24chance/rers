...
import { LayoutDashboard, FileText, CreditCard, Receipt, LogOut, Menu, X } from 'lucide-react'
...
const navLinks = [
  { href: '/finance/dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-5 w-5" />, exact: true },
  { href: '/finance/invoices', label: 'Invoices', icon: <FileText className="h-5 w-5" /> },
  { href: '/finance/payments', label: 'Payments', icon: <CreditCard className="h-5 w-5" /> },
  { href: '/finance/receipts', label: 'Receipts', icon: <Receipt className="h-5 w-5" /> },
]
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-white/10">
          <p className="text-xs font-semibold text-white/40 uppercase tracking-wider">Finance</p>
        </div>
        ...
        <div className="border-t border-white/10 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/50 truncate">Finance Officer</p>
            </div>
          </div>
        </div>
      </aside>
