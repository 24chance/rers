...
import { RnecAdminLayout } from '@/components/layout/rnec-admin-layout'
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  try {
    ...
    if (state?.user?.role !== 'RNEC_ADMIN') redirect('/login')
  } catch {
    redirect('/login')
  }

  return <RnecAdminLayout>{children}</RnecAdminLayout>
}
